...
* @version      V1.0
* @date         2017.07.25
* @brief        bluetooth_control(no tracking)
* @details
* @par History  
*
*/
...
//Define variables for data collected by various tracking infrared pins
...
/*Pin and variable Settings of obstacle avoidance infrared sensor*/
const int AvoidSensorLeft =  A3;   
const int AvoidSensorRight = A1;   
const int FollowSensorLeft =  A3;   
const int FollowSensorRight = A1;  

int LeftSensorValue ;               //Define variables to hold the size of the data collected by the infrared sensor
int RightSensorValue ;
String infrared_avoid_value = "00";

/*Pin and variable Settings of obstacle avoidance infrared sensor*/
const int LdrSensorLeft =  A4;   
const int LdrSensorRight = A2;   

int LdrSersorLeftValue ;         //Define variables to hold the size of the data collected by the photoresistor
int LdrSersorRightValue ;
String LDR_value = "00";

/*Set the control buzzer pin to A0*/
int buzzer = A0;                
...
float voltage_test()
{
  ...
  //Method 1: the voltage value is simulated by the circuit schematic and the port A0 
...
{
  //left motor back
  digitalWrite(Left_motor_go, LOW);     //enable left motor go
...
{
  int i = 0;
  for (i = 0; i <= 30; i++)    //The number of PWM is generated, 
